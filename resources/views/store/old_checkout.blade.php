...
<script>
    var modal = document.getElementById("modalOfficeLocate");
    var btn = document.getElementById("btnOfficeLocalization");
...
<span>Моля, попълнете полето за населеното място и натиснете бутона "Търсене", след това изберете най - удобния офис на Еконт за Вас.</span>
<iframe frameborder="0" id="officeLocator" scrolling="no" frameborder="0" style="border: medium none; width: 90%; height: 90%;" src="https://www.bgmaps.com/templates/econt"></iframe>
        ...
        <div class="row">
            <div class="col-sm-11">
                ...
                <form id="form-shipping" class="" name="form-shipping" action="/checkout" method="post">
                    ...
                    <div id="panel-delivery-method_old" class="elegant-aero">
